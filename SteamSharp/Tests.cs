...
namespace SteamSharp
{
    ...
    public class Tests
    {
        ...
        {
            var steamUser = new SteamApi("F90034D53FB8A0E51510978F7FDA261B");
        ...
        {
            var gameTimeList = _steamSharpTest.SteamUserGameTimeListById("F90034D53FB8A0E51510978F7FDA261B", "76561197960434622");
